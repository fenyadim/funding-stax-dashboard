...
import { Block, Button, Card, Flex, Input } from '@/components/ui';
	...
	return (
		...
		>
			<p className={styles.note}>
				<span>Note: </span>Your full name & country of residence must
				match those on your government-issued documents
			</p>
			...
			<Flex className={styles.cardWrapper} max>
				...
				<Card theme='negative' justify='between' gap='32'>
					<InfoText
						size='medium'
						value='Not required'
						title='KYC Status'
			...
			<Flex align='start' className={styles.changeWrapper} max gap='32'>
				<Card direction='column' gap='32' size='small'>
